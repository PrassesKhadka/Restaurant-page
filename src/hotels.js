...
export default function hotels()
{
    ...
    .addChild(new vdom('p').addAttributes({class:'font-hotels hide'}).addText('The Temple Tree Resort & Spa is a boutique hotel near Fewa Lake in Pokhara. Elegant and luxurious, the Temple Tree is all you could ask for in peace and comfort in tranquil surroundings.')))
